...
Capture images are generally images in PNG with white space (like OSX captures), here is the result : 
...
Want to see something else added? <a href="https://github.com/jbleuzen/sheekyl/issues/new">Open an issue.</a>
